import 'package:rapier/ast/node.dart';
...
class SimpleIdentifierContext extends IdentifierContext {
  ...
  @override
  T accept<T>(RapierVisitor<T> visitor) => visitor.visitSimpleIdentifier(this);
...
class NumberLiteralContext extends ExpressionContext {
  ...
  @override
  T accept<T>(RapierVisitor<T> visitor) => visitor.visitNumberLiteral(this);
...
class StringLiteralContext extends ExpressionContext {
  ...
  @override
  T accept<T>(RapierVisitor<T> visitor) => visitor.visitStringLiteral(this);
...
class BinaryExpressionContext extends ExpressionContext {
  ...
  @override
  T accept<T>(RapierVisitor<T> visitor) => visitor.visitBinaryExpression(this);
}
...
class PrefixExpressionContext extends ExpressionContext {
  ...
  @override
  T accept<T>(RapierVisitor<T> visitor) => visitor.visitPrefixExpression(this);
...
class PostfixExpressionContext extends ExpressionContext {
  ...
  @override
  T accept<T>(RapierVisitor<T> visitor) => visitor.visitPostfixExpression(this);
}
...
class CallExpressionContext extends ExpressionContext {
  ...
  @override
  T accept<T>(RapierVisitor<T> visitor) => visitor.visitCallExpression(this);
}
...
class MemberExpressionContext extends ExpressionContext {
  ...
  @override
  T accept<T>(RapierVisitor<T> visitor) => visitor.visitMemberExpression(this);
}
...
class ObjectLiteralContext extends ExpressionContext {
  ...
  @override
  T accept<T>(RapierVisitor<T> visitor) => visitor.visitObjectLiteral(this);
}
...
class RangeLiteralContext extends ExpressionContext {
  ...
  @override
  T accept<T>(RapierVisitor<T> visitor) => visitor.visitRangeLiteral(this);
}
